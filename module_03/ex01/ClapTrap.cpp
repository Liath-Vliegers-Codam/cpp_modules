...
// std::string ClapTrap::getClapTrapName(void)
// {
// 	return (_name);
// }

// unsigned int ClapTrap::getClapTrapHitPoints(void)
// {
// 	return (_hit_points);
// }

// unsigned int ClapTrap::getClapTrapEnergyPoints(void)
// {
// 	return (_energy_points);
// }

// unsigned int ClapTrap::getClapTrapAttackDamage(void)
// {
