...
void Contact::set_first_name(std::string input) { _first_name = input; }
void Contact::set_last_name(std::string input) { _last_name = input; }
void Contact::set_nick_name(std::string input) { _nick_name = input; }
void Contact::set_phone_number(std::string input) { _phone_number = input; }
void Contact::set_darkest_sectret(std::string input) { _darkest_secret = input; }
std::string Contact::get_first_name(void) { return (_first_name); }
std::string Contact::get_last_name(void) { return (_last_name); }
std::string Contact::get_nick_name(void) { return (_nick_name); }
std::string Contact::get_phone_number(void) { return (_phone_number); }
std::string Contact::get_darkest_sectret(void) { return (_darkest_secret); }
